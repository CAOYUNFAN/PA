...
//    if(strncmp(file_table[i].name,"/share/",8)==0) Log("File %s,id %d,size %u, offset %u",file_table[i].name,i,file_table[i].size,file_table[i].disk_offset);
    return i;
  }
